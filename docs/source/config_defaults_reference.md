...
_Auto-generated by `scripts/gen_defaults_table.py` from 518 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'MODEL'.'class_weight'`: `False` (nkululeko/models/model.py:278), `'False'` (nkululeko/models/model.py:302), `False` (nkululeko/models/model.py:317), `False` (nkululeko/models/model_aasist.py:159), `'auto'` (nkululeko/models/model_adm.py:93), `'False'` (nkululeko/models/model_svm.py:17), `False` (nkululeko/models/model_xgb.py:137)
...
* `'MODEL'.'loss'`: `'cross'` (nkululeko/models/model.py:93), `'cross'` (nkululeko/models/model_aasist.py:152), `'bce'` (nkululeko/models/model_adm.py:65), `'mse'` (nkululeko/models/model_mlp_regression.py:35)
...
| 'AASIST' | 'domain_balanced_sampling' | `False` | nkululeko/models/aasist_config.py:148 |
...
| 'AASIST' | 'rawboost_g_sd' | `'2'` | nkululeko/models/aasist_config.py:145 |
| 'AASIST' | 'rawboost_max_bias_lin_nonlin' | `'20'` | nkululeko/models/aasist_config.py:142 |
| 'AASIST' | 'rawboost_max_bw' | `'1000'` | nkululeko/models/aasist_config.py:129 |
| 'AASIST' | 'rawboost_max_coeff' | `'100'` | nkululeko/models/aasist_config.py:134 |
| 'AASIST' | 'rawboost_max_f' | `'8000'` | nkululeko/models/aasist_config.py:127 |
| 'AASIST' | 'rawboost_max_g' | `'0'` | nkululeko/models/aasist_config.py:137 |
| 'AASIST' | 'rawboost_min_bias_lin_nonlin' | `'5'` | nkululeko/models/aasist_config.py:139 |
| 'AASIST' | 'rawboost_min_bw' | `'100'` | nkululeko/models/aasist_config.py:128 |
| 'AASIST' | 'rawboost_min_coeff' | `'10'` | nkululeko/models/aasist_config.py:131 |
| 'AASIST' | 'rawboost_min_f' | `'20'` | nkululeko/models/aasist_config.py:126 |
| 'AASIST' | 'rawboost_min_g' | `'0'` | nkululeko/models/aasist_config.py:136 |
| 'AASIST' | 'rawboost_n_bands' | `'5'` | nkululeko/models/aasist_config.py:125 |
| 'AASIST' | 'rawboost_n_f' | `'5'` | nkululeko/models/aasist_config.py:124 |
| 'AASIST' | 'rawboost_p' | `'10'` | nkululeko/models/aasist_config.py:144 |
| 'AASIST' | 'rawboost_snr_max' | `'40'` | nkululeko/models/aasist_config.py:147 |
| 'AASIST' | 'rawboost_snr_min' | `'10'` | nkululeko/models/aasist_config.py:146 |
...
| 'MODEL' | 'loss' | `'bce'` / `'cross'` / `'mse'` | nkululeko/models/model.py:93, nkululeko/models/model_aasist.py:152, nkululeko/models/model_adm.py:65, +1 more |
...
| 'MODEL' | 'random_seed' | `'False'` | nkululeko/models/model_aasist.py:108, nkululeko/models/model_adm.py:51, nkululeko/models/model_mlp.py:33, +2 more |
