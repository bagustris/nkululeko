...
_Auto-generated by `scripts/gen_defaults_table.py` from 526 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
|---|---|---|---|
| 'AASIST' | 'batch_size' | `'24'` | nkululeko/models/aasist_config.py:87 |
| 'AASIST' | 'freeze_ssl_frontend' | `False` | nkululeko/models/aasist_config.py:103 |
| 'AASIST' | 'max_len' | `'64600'` | nkululeko/models/aasist_config.py:85 |
| 'AASIST' | 'rawboost_algo' | `'0'` | nkululeko/models/aasist_config.py:110 |
| 'AASIST' | 'rawboost_g_sd' | `'2'` | nkululeko/models/aasist_config.py:152 |
| 'AASIST' | 'rawboost_max_bias_lin_nonlin' | `'20'` | nkululeko/models/aasist_config.py:149 |
| 'AASIST' | 'rawboost_max_bw' | `'1000'` | nkululeko/models/aasist_config.py:136 |
| 'AASIST' | 'rawboost_max_coeff' | `'100'` | nkululeko/models/aasist_config.py:141 |
| 'AASIST' | 'rawboost_max_f' | `'8000'` | nkululeko/models/aasist_config.py:134 |
| 'AASIST' | 'rawboost_max_g' | `'0'` | nkululeko/models/aasist_config.py:144 |
| 'AASIST' | 'rawboost_min_bias_lin_nonlin' | `'5'` | nkululeko/models/aasist_config.py:146 |
| 'AASIST' | 'rawboost_min_bw' | `'100'` | nkululeko/models/aasist_config.py:135 |
| 'AASIST' | 'rawboost_min_coeff' | `'10'` | nkululeko/models/aasist_config.py:138 |
| 'AASIST' | 'rawboost_min_f' | `'20'` | nkululeko/models/aasist_config.py:133 |
| 'AASIST' | 'rawboost_min_g' | `'0'` | nkululeko/models/aasist_config.py:143 |
| 'AASIST' | 'rawboost_n_bands' | `'5'` | nkululeko/models/aasist_config.py:132 |
| 'AASIST' | 'rawboost_n_f' | `'5'` | nkululeko/models/aasist_config.py:131 |
| 'AASIST' | 'rawboost_p' | `'10'` | nkululeko/models/aasist_config.py:151 |
| 'AASIST' | 'rawboost_snr_max' | `'40'` | nkululeko/models/aasist_config.py:154 |
| 'AASIST' | 'rawboost_snr_min' | `'10'` | nkululeko/models/aasist_config.py:153 |
| 'AASIST' | 'ssl_layer_pooling' | `'last'` | nkululeko/models/aasist_config.py:93 |
| 'AASIST' | 'ssl_model' | `'facebook/wav2vec2-xls-r-300m'` | nkululeko/models/aasist_config.py:78 |
...
| 'FEATS' | 'balancing' | `False` | nkululeko/modelrunner.py:432 |
| 'FEATS' | 'balancing_random_state' | `42` | nkululeko/modelrunner.py:438 |
...
| 'MODEL' | 'activation' | `'relu'` | nkululeko/models/model_mlp.py:99, nkululeko/models/model_mlp_regression.py:89 |
| 'MODEL' | 'adm.branches' | `'time,spectral,phase'` / `'time,spectral,phase,lfcc,cqcc'` | nkululeko/models/model_adm.py:142, nkululeko/models/model_adm.py:593, nkululeko/utils/naming.py:153 |
| 'MODEL' | 'adm.fusion' | `'weighted'` | nkululeko/models/model_adm.py:136, nkululeko/models/model_adm.py:588 |
| 'MODEL' | 'adm.hidden_dim' | `'256'` | nkululeko/models/model_adm.py:138, nkululeko/models/model_adm.py:590 |
| 'MODEL' | 'batch_size' | `32` / `8` | nkululeko/models/model_adm.py:192, nkululeko/models/model_cnn.py:71, nkululeko/models/model_mlp.py:81, +1 more |
...
| 'MODEL' | 'dann_columns' | `[]` | nkululeko/models/aasist_config.py:165 |
| 'MODEL' | 'dann_lambda' | `'1.0'` | nkululeko/models/aasist_config.py:166 |
| 'MODEL' | 'dann_reverse' | `True` | nkululeko/models/aasist_config.py:168 |
| 'MODEL' | 'dann_weight' | `'1.0'` | nkululeko/models/aasist_config.py:167 |
...
| 'MODEL' | 'domain_balanced_sampling' | `False` | nkululeko/models/aasist_config.py:155, nkululeko/models/model_adm.py:199, nkululeko/models/model_mlp.py:89 |
...
| 'MODEL' | 'feature_noise' | `'0.0'` | nkululeko/models/model_adm.py:208 |
| 'MODEL' | 'focal.alpha' | `0.25` | nkululeko/models/model_adm.py:80 |
| 'MODEL' | 'focal.gamma' | `2.0` | nkululeko/models/model_adm.py:82 |
...
| 'MODEL' | 'learning_rate' | `0.3` / `str(default_lr)` | nkululeko/models/model_xgb.py:32, nkululeko/optimizers/optimizer_factory.py:44 |
| 'MODEL' | 'logo' | `False` | nkululeko/experiment.py:71, nkululeko/models/model.py:37 |
| 'MODEL' | 'loso' | `False` | nkululeko/experiment.py:70 |
| 'MODEL' | 'loss' | `'bce'` / `'cross'` / `'mse'` | nkululeko/models/model.py:93, nkululeko/models/model_aasist.py:220, nkululeko/models/model_adm.py:67, +1 more |
| 'MODEL' | 'max_depth' | `6` | nkululeko/models/model_xgb.py:31 |
| 'MODEL' | 'max_grad_norm' | `'0.0'` | nkululeko/models/model_adm.py:205 |
...
| 'MODEL' | 'momentum' | `'0.9'` | nkululeko/optimizers/optimizer_factory.py:61 |
...
| 'MODEL' | 'optimizer' | `default_optimizer` | nkululeko/optimizers/optimizer_factory.py:45 |
| 'MODEL' | 'patience' | `False` | nkululeko/modelrunner.py:170, nkululeko/models/model_tuned.py:146 |
| 'MODEL' | 'random_seed' | `'False'` | nkululeko/models/model_aasist.py:137, nkululeko/models/model_adm.py:53, nkululeko/models/model_mlp.py:35, +2 more |
| 'MODEL' | 'sam' | `False` | nkululeko/optimizers/optimizer_factory.py:46 |
| 'MODEL' | 'sam_rho' | `'0.05'` | nkululeko/optimizers/optimizer_factory.py:47 |
...
| 'MODEL' | 'threshold' | `'0.5'` | nkululeko/models/model_adm.py:210 |
...
| 'MODEL' | 'weight_decay' | `'0.01'` | nkululeko/optimizers/optimizer_factory.py:50 |
