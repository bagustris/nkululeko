...
_Auto-generated by `scripts/gen_defaults_table.py` from 522 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'MODEL'.'loss'`: `'cross'` (nkululeko/models/model.py:93), `'cross'` (nkululeko/models/model_aasist.py:153), `'bce'` (nkululeko/models/model_adm.py:67), `'mse'` (nkululeko/models/model_mlp_regression.py:35)
...
|---|---|---|---|
| 'AASIST' | 'batch_size' | `'24'` | nkululeko/models/aasist_config.py:83 |
| 'AASIST' | 'freeze_ssl_frontend' | `False` | nkululeko/models/aasist_config.py:99 |
| 'AASIST' | 'max_len' | `'64600'` | nkululeko/models/aasist_config.py:81 |
| 'AASIST' | 'rawboost_algo' | `'0'` | nkululeko/models/aasist_config.py:106 |
| 'AASIST' | 'rawboost_g_sd' | `'2'` | nkululeko/models/aasist_config.py:148 |
| 'AASIST' | 'rawboost_max_bias_lin_nonlin' | `'20'` | nkululeko/models/aasist_config.py:145 |
| 'AASIST' | 'rawboost_max_bw' | `'1000'` | nkululeko/models/aasist_config.py:132 |
| 'AASIST' | 'rawboost_max_coeff' | `'100'` | nkululeko/models/aasist_config.py:137 |
| 'AASIST' | 'rawboost_max_f' | `'8000'` | nkululeko/models/aasist_config.py:130 |
| 'AASIST' | 'rawboost_max_g' | `'0'` | nkululeko/models/aasist_config.py:140 |
| 'AASIST' | 'rawboost_min_bias_lin_nonlin' | `'5'` | nkululeko/models/aasist_config.py:142 |
| 'AASIST' | 'rawboost_min_bw' | `'100'` | nkululeko/models/aasist_config.py:131 |
| 'AASIST' | 'rawboost_min_coeff' | `'10'` | nkululeko/models/aasist_config.py:134 |
| 'AASIST' | 'rawboost_min_f' | `'20'` | nkululeko/models/aasist_config.py:129 |
| 'AASIST' | 'rawboost_min_g' | `'0'` | nkululeko/models/aasist_config.py:139 |
| 'AASIST' | 'rawboost_n_bands' | `'5'` | nkululeko/models/aasist_config.py:128 |
| 'AASIST' | 'rawboost_n_f' | `'5'` | nkululeko/models/aasist_config.py:127 |
| 'AASIST' | 'rawboost_p' | `'10'` | nkululeko/models/aasist_config.py:147 |
| 'AASIST' | 'rawboost_snr_max' | `'40'` | nkululeko/models/aasist_config.py:150 |
| 'AASIST' | 'rawboost_snr_min' | `'10'` | nkululeko/models/aasist_config.py:149 |
| 'AASIST' | 'ssl_layer_pooling' | `'last'` | nkululeko/models/aasist_config.py:89 |
| 'AASIST' | 'ssl_model' | `'facebook/wav2vec2-xls-r-300m'` | nkululeko/models/aasist_config.py:74 |
...
| 'MODEL' | 'domain_balanced_sampling' | `False` | nkululeko/models/aasist_config.py:151, nkululeko/models/model_adm.py:199, nkululeko/models/model_mlp.py:89 |
...
| 'MODEL' | 'loss' | `'bce'` / `'cross'` / `'mse'` | nkululeko/models/model.py:93, nkululeko/models/model_aasist.py:153, nkululeko/models/model_adm.py:67, +1 more |
...
| 'MODEL' | 'random_seed' | `'False'` | nkululeko/models/model_aasist.py:109, nkululeko/models/model_adm.py:53, nkululeko/models/model_mlp.py:35, +2 more |
