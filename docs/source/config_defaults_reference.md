...
_Auto-generated by `scripts/gen_defaults_table.py` from 515 `config_val*()` call sites across `nkululeko/`. Do not edit by hand - run `python scripts/gen_defaults_table.py --write` to refresh._
...
* `'MODEL'.'loss'`: `'cross'` (nkululeko/models/model.py:93), `'cross'` (nkululeko/models/model_aasist.py:143), `'bce'` (nkululeko/models/model_adm.py:65), `'mse'` (nkululeko/models/model_mlp_regression.py:35)
...
|---|---|---|---|
| 'AASIST' | 'batch_size' | `'24'` | nkululeko/models/aasist_config.py:70 |
| 'AASIST' | 'device' | `False` | nkululeko/models/aasist_config.py:50 |
| 'AASIST' | 'max_len' | `'64600'` | nkululeko/models/aasist_config.py:68 |
| 'AASIST' | 'rawboost_algo' | `'0'` | nkululeko/models/aasist_config.py:75 |
| 'AASIST' | 'rawboost_g_sd' | `'2'` | nkululeko/models/aasist_config.py:107 |
| 'AASIST' | 'rawboost_max_bias_lin_nonlin' | `'20'` | nkululeko/models/aasist_config.py:104 |
| 'AASIST' | 'rawboost_max_bw' | `'1000'` | nkululeko/models/aasist_config.py:91 |
| 'AASIST' | 'rawboost_max_coeff' | `'100'` | nkululeko/models/aasist_config.py:96 |
| 'AASIST' | 'rawboost_max_f' | `'8000'` | nkululeko/models/aasist_config.py:89 |
| 'AASIST' | 'rawboost_max_g' | `'0'` | nkululeko/models/aasist_config.py:99 |
| 'AASIST' | 'rawboost_min_bias_lin_nonlin' | `'5'` | nkululeko/models/aasist_config.py:101 |
| 'AASIST' | 'rawboost_min_bw' | `'100'` | nkululeko/models/aasist_config.py:90 |
| 'AASIST' | 'rawboost_min_coeff' | `'10'` | nkululeko/models/aasist_config.py:93 |
| 'AASIST' | 'rawboost_min_f' | `'20'` | nkululeko/models/aasist_config.py:88 |
| 'AASIST' | 'rawboost_min_g' | `'0'` | nkululeko/models/aasist_config.py:98 |
| 'AASIST' | 'rawboost_n_bands' | `'5'` | nkululeko/models/aasist_config.py:87 |
| 'AASIST' | 'rawboost_n_f' | `'5'` | nkululeko/models/aasist_config.py:86 |
| 'AASIST' | 'rawboost_p' | `'10'` | nkululeko/models/aasist_config.py:106 |
| 'AASIST' | 'rawboost_snr_max' | `'40'` | nkululeko/models/aasist_config.py:109 |
| 'AASIST' | 'rawboost_snr_min' | `'10'` | nkululeko/models/aasist_config.py:108 |
| 'AASIST' | 'ssl_model' | `'facebook/wav2vec2-xls-r-300m'` | nkululeko/models/aasist_config.py:61 |
...
| 'MODEL' | 'loss' | `'bce'` / `'cross'` / `'mse'` | nkululeko/models/model.py:93, nkululeko/models/model_aasist.py:143, nkululeko/models/model_adm.py:65, +1 more |
...
| 'MODEL' | 'random_seed' | `'False'` | nkululeko/models/model_aasist.py:101, nkululeko/models/model_adm.py:51, nkululeko/models/model_mlp.py:33, +2 more |
