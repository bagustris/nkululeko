...
* **label_smoothing**: label smoothing factor for cross-entropy loss (0.0 to 1.0). Helps prevent overconfidence and can improve generalization.
  * label_smoothing = 0.1
  * Set to True to use default value of 0.1
